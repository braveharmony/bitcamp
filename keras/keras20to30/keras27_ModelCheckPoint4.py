...
hist=model.fit(x_train,y_train,epochs=100
          ...
          callbacks=(EarlyStopping(monitor='val_loss',mode='min',
                     ...
                     ModelCheckpoint(monitor='val_loss',mode='auto',save_best_only=True,verbose=True,
                                    #  filepath=''.join((f'./_save/MCP/keras27_4/k27_{date}_','{epoch:04d}-{val_loss:.4f}.hdf5'))
                                     )))
