...
from tensorflow.keras.layers import Input,Dense,LeakyReLU,Dropout,Conv2D,Flatten
...
x_train=np.reshape(x_train,(x_train.shape[0],x_train.shape[1]//2,2,1))
x_test=np.reshape(x_test,(x_test.shape[0],x_test.shape[1]//2,2,1))
print(x_train.shape,x_test.shape)
