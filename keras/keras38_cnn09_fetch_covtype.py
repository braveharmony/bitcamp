...
x_train=np.reshape(x_train,(x_train.shape[0],x_train.shape[1]//(3*6),3,6))
x_test=np.reshape(x_test,(x_test.shape[0],x_test.shape[1]//(3*6),3,6))
print(x_train.shape,x_test.shape)
...
hist=model.fit(x_train,y_train,epochs=10000
          ,verbose=True,validation_split=0.2,batch_size=len(x_train)//250
