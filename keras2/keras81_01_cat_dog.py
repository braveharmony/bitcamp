...
# 1. data prepare
path='d:/study_data/_save/keras58/_8/'
...
print(f'Cat : {np.round(result[0][0],3)*100} Dog : {np.round(result[0][1],3)*100}')
...
# loss: 0.5236377716064453
# val_loss: 0.5421069264411926
# acc: 0.7384999990463257
# val_acc: 0.7325999736785889