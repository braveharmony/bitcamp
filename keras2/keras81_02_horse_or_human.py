...
from tensorflow.keras.applications import ResNet50V2,VGG19,ResNet101V2
model=Sequential()
pretrained=ResNet101V2(include_top=False,input_shape=x_train.shape[1:])
...
print(f'horse : {np.round(result[0][0],3)*100} human : {np.round(result[0][1],3)*100}')
...
# loss: 0.002504826756194234
# val_loss: 2.068316643999424e-05
# acc: 0.9993351101875305
# val_acc: 1.0