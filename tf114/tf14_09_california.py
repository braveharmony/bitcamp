...
w1 = tf.compat.v1.Variable(tf.compat.v1.random_normal([8, 16]), name='weight1')
b1 = tf.compat.v1.Variable(tf.compat.v1.zeros([16]), name='bias1')
layer1 = tf.compat.v1.matmul(xp, w1) + b1                                                           

layer1 = tf.compat.v1.nn.leaky_relu(layer1, alpha=0.95)

w2 = tf.compat.v1.Variable(tf.compat.v1.random_normal([16, 32]), name='weight2')
b2 = tf.compat.v1.Variable(tf.compat.v1.zeros([32]), name='bias2')
layer2 = tf.compat.v1.matmul(layer1, w2) + b2

layer2 = tf.compat.v1.nn.leaky_relu(layer2, alpha=0.95)
