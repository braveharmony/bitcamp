...
w2=tf.compat.v1.Variable(tf.compat.v1.random_normal([32,32],dtype=tf.float32))
b2=tf.compat.v1.Variable(tf.compat.v1.random_normal([32],dtype=tf.float32))
layer2=tf.compat.v1.matmul(layer1,w2)+b2

layer2=tf.compat.v1.nn.relu(layer2)

w3=tf.compat.v1.Variable(tf.compat.v1.random_normal([32,1],dtype=tf.float32))
b3=tf.compat.v1.Variable(tf.compat.v1.random_normal([1],dtype=tf.float32))
layer3=tf.compat.v1.matmul(layer2,w3)+b3

hypothesis=tf.compat.v1.nn.sigmoid(layer3)
