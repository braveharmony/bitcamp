...
# 원본 플롯
plt.figure(0)
sns.lineplot(a, palette=[palette])
...
plt.subplot(2, 2, 1)
sns.lineplot(aMMS, palette=[palette])
...
plt.subplot(2, 2, 2)
sns.lineplot(aMAS, palette=[palette])
...
plt.subplot(2, 2, 3)
sns.lineplot(aSS, palette=[palette])
...
plt.subplot(2, 2, 4)
sns.lineplot(aRS, palette=[palette])
